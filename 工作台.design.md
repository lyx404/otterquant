...
The following OKLCH palette is the implemented dark-mode baseline for the quantitative workbench. It is synchronized with `client/src/pages/MyStrategies.css`, `client/src/pages/Account.css`, and `client/src/pages/StrategyFigmaReportCharts.css`, and supersedes the legacy Hex dark mapping for workbench pages, dialogs, popovers, menus, tooltips, and toasts.

| Token | Value | Intent | Primary usage |
|-------|-------|--------|---------------|
| `canvas` | `oklch(0.155 0.006 57.433)` | App canvas | Page background and dark foreground on orange controls |
| `surface-1` | `oklch(0.215 0.009 57)` | Base surface | Dialogs, cards, inputs, menus |
| `surface-2` | `oklch(0.255 0.012 60)` | Raised surface | Toolbars, table rows, dialog body and footer |
| `surface-warm` | `oklch(0.235 0.025 55)` | Temporary warm emphasis | Hover states only |
| `surface-3` | `oklch(0.295 0.014 65)` | Selected surface | Selected rows, chips, active neutral controls |
| `surface-4` | `oklch(0.345 0.016 65)` | Strong selected surface | Rare high-emphasis neutral states; not the default segmented-control selection |
| `border` | `oklch(0.34 0.016 67)` | Structural divider | Non-interactive separators |
| `border-strong` | `oklch(0.51 0.023 67)` | Interactive boundary | Inputs, buttons, rows and chips |
| `border-emphasis` | `oklch(0.6 0.025 65)` | Emphasized boundary | Selected panels, search fields and high-priority controls |
| `text` | `oklch(0.95 0.014 68)` | Primary text | Titles, values and primary labels |
| `text-warm` | `oklch(0.89 0.019 68)` | Warm primary text | Menu items and warm surfaces |
| `text-soft` | `oklch(0.8 0.022 65)` | Secondary text | Controls and supporting content |
| `muted` | `oklch(0.68 0.021 67)` | Muted text | Descriptions and low-priority metadata |
| `muted-strong` | `oklch(0.75 0.021 65)` | Readable muted text | Dense table metadata, counts and compact labels |
| `accent` | `oklch(0.72 0.185 47)` | Brand action | Primary actions, focus and transient hover |
| `accent-hover` | `oklch(0.81 0.13 58)` | Brand hover foreground | Hovered removable items and highlighted actions |
...
| `segment-active-border` | `oklch(0.409 0.05 55.41)` | Low emphasis active boundary | Selected segment inside a segmented controller |
...
Dark surfaces use warm-neutral hues around `57–68` with low chroma. Accent colors must encode an action or state; do not use orange as a persistent panel fill. Selected collections use `surface-3` plus an accent check or icon, while hover may temporarily use `surface-warm`.
...
| Selected row or chip | `surface-3` + `border-emphasis` |
| Segmented-control container | `surface-2` + `border` |
| Selected segment | `surface-1` + `segment-active-border` + `accent`; do not use `surface-4` by default |
...
```json design-tokens
{
  ...
  "colorModes": {
    ...
    "workbenchDark": {
      "canvas": "oklch(0.155 0.006 57.433)",
      "surface-1": "oklch(0.215 0.009 57)",
      "surface-2": "oklch(0.255 0.012 60)",
      "surface-warm": "oklch(0.235 0.025 55)",
      "surface-3": "oklch(0.295 0.014 65)",
      "surface-4": "oklch(0.345 0.016 65)",
      "border": "oklch(0.34 0.016 67)",
      "border-strong": "oklch(0.51 0.023 67)",
      "border-emphasis": "oklch(0.6 0.025 65)",
      "text": "oklch(0.95 0.014 68)",
      "text-warm": "oklch(0.89 0.019 68)",
      "text-soft": "oklch(0.8 0.022 65)",
      "muted": "oklch(0.68 0.021 67)",
      "muted-strong": "oklch(0.75 0.021 65)",
      "accent": "oklch(0.72 0.185 47)",
      "accent-hover": "oklch(0.81 0.13 58)",
      ...
      "segment-active-border": "oklch(0.409 0.05 55.41)",
