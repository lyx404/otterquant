...
const strategyDetailCopy: Record<string, UiCopy> = {
  ...
  "Back to My Strategies": { ja: "マイストラテジーに戻る", ko: "내 전략으로 돌아가기", es: "Volver a Mis estrategias", fr: "Retour à Mes stratégies" },
  "Updated at": { ja: "更新日時", ko: "업데이트", es: "Actualizado el", fr: "Mis à jour le" },
  ...
  "Custom start date": { ja: "開始日を指定", ko: "시작일 지정", es: "Fecha de inicio personalizada", fr: "Date de début personnalisée" },
  Calmar: { ja: "カルマーレシオ", ko: "칼마 비율", es: "Ratio de Calmar", fr: "Ratio de Calmar" },
  MDD: { ja: "最大ドローダウン", ko: "최대 낙폭", es: "Máximo drawdown", fr: "Drawdown maximal" },
  ...
  "Measures return relative to maximum drawdown. Higher values are better.": {
    ja: "最大ドローダウンに対するリターンを示します。値が高いほど良好です。",
    ko: "최대 낙폭 대비 수익을 나타냅니다. 값이 높을수록 좋습니다.",
    es: "Mide el retorno respecto al máximo drawdown. Los valores más altos son mejores.",
    fr: "Mesure le rendement par rapport au drawdown maximal. Une valeur élevée est préférable.",
  },
  "Shows the percentage of profitable trades.": {
    ja: "利益となった取引の割合を示します。",
    ko: "수익 거래의 비율을 나타냅니다.",
    es: "Muestra el porcentaje de operaciones rentables.",
    fr: "Indique le pourcentage de transactions rentables.",
  },
  "Shows how often positions change. Higher values mean more frequent trading.": {
    ja: "ポジションの変更頻度を示します。値が高いほど取引頻度が高くなります。",
    ko: "포지션 변경 빈도를 나타냅니다. 값이 높을수록 거래가 더 빈번합니다.",
    es: "Muestra la frecuencia con la que cambian las posiciones. Los valores más altos implican más operaciones.",
    fr: "Indique la fréquence de modification des positions. Une valeur élevée signifie des transactions plus fréquentes.",
  },
  "Fee rate applied to each trade in the backtest.": {
    ja: "バックテストの各取引に適用される手数料率です。",
    ko: "백테스트의 각 거래에 적용되는 수수료율입니다.",
    es: "Tasa de comisión aplicada a cada operación del backtest.",
    fr: "Taux de frais appliqué à chaque transaction du backtest.",
  },
  "Annualized return after trading costs.": {
    ja: "取引コスト控除後の年率リターンです。",
    ko: "거래 비용 차감 후 연환산 수익률입니다.",
    es: "Retorno anualizado después de costes de negociación.",
    fr: "Rendement annualisé après coûts de transaction.",
  },
  "Return stability after trading costs. Higher values generally indicate steadier performance.": {
    ja: "取引コスト控除後のリターン安定性です。一般に値が高いほど安定しています。",
    ko: "거래 비용 차감 후 수익 안정성입니다. 일반적으로 값이 높을수록 안정적입니다.",
    es: "Estabilidad del retorno después de costes. Los valores más altos suelen indicar un rendimiento más estable.",
    fr: "Stabilité du rendement après coûts de transaction. Une valeur élevée indique généralement une performance plus stable.",
  },
  "Annualized return before trading costs.": {
    ja: "取引コスト控除前の年率リターンです。",
    ko: "거래 비용 차감 전 연환산 수익률입니다.",
    es: "Retorno anualizado antes de costes de negociación.",
    fr: "Rendement annualisé avant coûts de transaction.",
  },
  "Return stability before trading costs. Higher values generally indicate steadier performance.": {
    ja: "取引コスト控除前のリターン安定性です。一般に値が高いほど安定しています。",
    ko: "거래 비용 차감 전 수익 안정성입니다. 일반적으로 값이 높을수록 안정적입니다.",
    es: "Estabilidad del retorno antes de costes. Los valores más altos suelen indicar un rendimiento más estable.",
    fr: "Stabilité du rendement avant coûts de transaction. Une valeur élevée indique généralement une performance plus stable.",
  },
  "Average position turnover per period. Higher values mean more frequent trading.": {
    ja: "期間ごとの平均ポジション回転率です。値が高いほど取引頻度が高くなります。",
    ko: "기간당 평균 포지션 회전율입니다. 값이 높을수록 거래가 더 빈번합니다.",
    es: "Rotación media de posiciones por periodo. Los valores más altos implican más operaciones.",
    fr: "Turnover moyen des positions par période. Une valeur élevée signifie des transactions plus fréquentes.",
  },
  "Cumulative trading cost from position turnover, expressed as return.": {
    ja: "ポジション回転による累積取引コストをリターンとして示します。",
    ko: "포지션 회전으로 발생한 누적 거래 비용을 수익률로 나타냅니다.",
    es: "Coste de negociación acumulado por la rotación de posiciones, expresado como retorno.",
    fr: "Coût de transaction cumulé lié au turnover des positions, exprimé en rendement.",
  },
  "Cumulative profit or cost from funding fees.": {
    ja: "Funding 手数料による累積損益です。",
    ko: "펀딩 수수료로 인한 누적 손익입니다.",
    es: "Beneficio o coste acumulado por tasas de funding.",
    fr: "Profit ou coût cumulé lié aux frais de funding.",
  },
  "Number of periods included in this backtest.": {
    ja: "このバックテストに含まれる期間数です。",
    ko: "이 백테스트에 포함된 기간 수입니다.",
    es: "Número de periodos incluidos en este backtest.",
    fr: "Nombre de périodes incluses dans ce backtest.",
  },
  "Strategy deleted successfully.": { ja: "ストラテジーを削除しました。", ko: "전략이 삭제되었습니다.", es: "Estrategia eliminada correctamente.", fr: "Stratégie supprimée." },
  "Latest version": { ja: "最新バージョン", ko: "최신 버전", es: "Última versión", fr: "Dernière version" },
  Version: { ja: "バージョン", ko: "버전", es: "Versión", fr: "Version" },
  "Edited update": { ja: "編集による更新", ko: "편집 업데이트", es: "Actualización editada", fr: "Mise à jour manuelle" },
  "Generated by optimizer": { ja: "オプティマイザー生成", ko: "옵티마이저 생성", es: "Generada por el optimizador", fr: "Générée par l'optimiseur" },
  "Note: ": { ja: "メモ：", ko: "메모: ", es: "Nota: ", fr: "Note : " },
  "Adjusted factor weights to reduce portfolio volatility.": {
    ja: "ファクターウェイトを調整し、ポートフォリオのボラティリティを低減しました。",
    ko: "팩터 가중치를 조정해 포트폴리오 변동성을 낮췄습니다.",
    es: "Se ajustaron los pesos de factores para reducir la volatilidad de la cartera.",
    fr: "Les poids des facteurs ont été ajustés pour réduire la volatilité du portefeuille.",
  },
  Viewing: { ja: "表示中", ko: "보는 중", es: "En pantalla", fr: "Affichée" },
  View: { ja: "表示", ko: "보기", es: "Ver", fr: "Voir" },
  "View (Processing)": { ja: "表示（処理中）", ko: "보기(처리 중)", es: "Ver (procesando)", fr: "Voir (traitement)" },
  "Review and manage the strategy's version history.": {
    ja: "ストラテジーのバージョン履歴を確認・管理します。",
    ko: "전략 버전 기록을 확인하고 관리합니다.",
  ...
  "Conservative prioritizes stability; Balanced balances return, risk, and cost; Aggressive pursues more return potential with higher exposure.": {
    ja: "保守的は安定性を優先し、バランスはリターン・リスク・コストを均衡させ、積極的は高いエクスポージャーでより大きなリターンを狙います。",
    ko: "보수적은 안정성을 우선하고, 균형은 수익·위험·비용의 균형을 맞추며, 공격적은 더 높은 익스포저로 더 큰 수익 가능성을 추구합니다.",
    es: "Conservador prioriza la estabilidad; Equilibrado compensa retorno, riesgo y coste; Agresivo busca más retorno con mayor exposición.",
    fr: "Prudent privilégie la stabilité ; Équilibré arbitre rendement, risque et coût ; Agressif vise plus de rendement avec une exposition accrue.",
  },
  "Lower exposure and tighter risk limits prioritize stability.": {
    ja: "エクスポージャーを抑え、リスク制限を厳しくして安定性を優先します。",
    ko: "익스포저를 낮추고 위험 한도를 강화해 안정성을 우선합니다.",
    es: "Una menor exposición y límites de riesgo más estrictos priorizan la estabilidad.",
    fr: "Une exposition réduite et des limites de risque plus strictes privilégient la stabilité.",
  },
  "Balances return potential, risk, and trading costs.": {
    ja: "リターンの可能性、リスク、取引コストのバランスを取ります。",
    ko: "수익 가능성, 위험, 거래 비용의 균형을 맞춥니다.",
    es: "Equilibra el potencial de retorno, el riesgo y los costes de negociación.",
  ...
  "Higher exposure and looser limits pursue more return potential.": {
    ja: "エクスポージャーを高め、制限を緩和してより大きなリターンを狙います。",
    ko: "익스포저를 높이고 한도를 완화해 더 큰 수익 가능성을 추구합니다.",
    es: "Una mayor exposición y límites más flexibles buscan un mayor potencial de retorno.",
    fr: "Une exposition accrue et des limites plus souples visent un potentiel de rendement supérieur.",
  },
  ...
  "Review the strategy direction, ranking rule and factor weights.": {
    ja: "売買方向、ランキングルール、ファクターウェイトを確認します。",
    ko: "전략 방향, 순위 규칙, 팩터 가중치를 확인합니다.",
    es: "Revisa el lado de la estrategia, la regla de ranking y los pesos de factores.",
    fr: "Consultez le sens de la stratégie, la règle de classement et les poids des facteurs.",
  },
  high: { ja: "高い", ko: "높음", es: "alto", fr: "élevé" },
  moderate: { ja: "中程度", ko: "보통", es: "moderado", fr: "modéré" },
  low: { ja: "低い", ko: "낮음", es: "bajo", fr: "faible" },
  "well controlled": { ja: "良好に管理", ko: "잘 통제됨", es: "bien controlado", fr: "bien maîtrisé" },
  noticeable: { ja: "要注意", ko: "주의 필요", es: "significativo", fr: "notable" },
  "high risk": { ja: "高リスク", ko: "높은 위험", es: "riesgo alto", fr: "risque élevé" },
};
