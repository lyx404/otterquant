...
const reportCopy: Record<string, UiCopy> = {
  ...
  Autocorrelation: { ja: "自己相関", ko: "자기상관", es: "Autocorrelación", fr: "Autocorrélation" },
  "Turnover rate": { ja: "売買回転率", ko: "회전율", es: "Tasa de rotación", fr: "Taux de turnover" },
  "EMA250 correlation": { ja: "EMA250 相関", ko: "EMA250 상관", es: "Correlación EMA250", fr: "Corrélation EMA250" },
  "Cumulative return": { ja: "累積リターン", ko: "누적 수익률", es: "Retorno acumulado", fr: "Rendement cumulé" },
  PnL: { ja: "PnL", ko: "PnL", es: "PnL", fr: "PnL" },
  "Delta vs EMA30": { ja: "EMA30 乖離", ko: "EMA30 대비 편차", es: "Diferencia frente a EMA30", fr: "Écart par rapport à EMA30" },
  "decile cumulative return lines": {
    ja: "本の十分位累積リターン線",
    ko: "개 분위 누적 수익률 선",
    es: "líneas de retorno acumulado por decil",
    fr: "courbes de rendement cumulé par décile",
  },
  "prediction return autocorrelation decay lines": {
    ja: "本の予測リターン自己相関減衰線",
    ko: "개 예측 수익률 자기상관 감쇠선",
    es: "líneas de decaimiento de autocorrelación del retorno predictivo",
    fr: "courbes de décroissance de l'autocorrélation du rendement prédictif",
  },
  "Prediction-Barra EMA250 correlation lines": {
    ja: "本の Prediction-Barra EMA250 相関線",
    ko: "개 Prediction-Barra EMA250 상관선",
    es: "líneas de correlación Prediction-Barra EMA250",
    fr: "courbes de corrélation Prediction-Barra EMA250",
  },
  "daily turnover rate lines": {
    ja: "本の日次売買回転率線",
    ko: "개 일간 회전율 선",
    es: "líneas de tasa de rotación diaria",
    fr: "courbes de taux de turnover quotidien",
  },
  "Barra style cumulative return lines": {
    ja: "本の Barra スタイル累積リターン線",
    ko: "개 Barra 스타일 누적 수익률 선",
    es: "líneas de retorno acumulado de estilos Barra",
    fr: "courbes de rendement cumulé des styles Barra",
  },
  "Prediction decile cumulative return": {
    ja: "予測十分位累積リターン",
    ko: "예측 분위 누적 수익률",
    es: "Retorno acumulado por decil predictivo",
    fr: "Rendement cumulé par décile prédictif",
  },
  "Style long-short cumulative return": {
    ja: "スタイル Long-Short 累積リターン",
    ko: "스타일 롱숏 누적 수익률",
    es: "Retorno acumulado long-short de estilos",
    fr: "Rendement cumulé long-short des styles",
  },
  "Style exposure": { ja: "スタイルエクスポージャー", ko: "스타일 익스포저", es: "Exposición de estilos", fr: "Exposition aux styles" },
  "Prediction decay": { ja: "予測減衰", ko: "예측 감쇠", es: "Decaimiento predictivo", fr: "Décroissance prédictive" },
  "Prediction style correlation": {
    ja: "予測とスタイルの相関",
    ko: "예측-스타일 상관",
    es: "Correlación entre predicción y estilos",
    fr: "Corrélation prédiction-styles",
  },
  "Daily turnover rate": { ja: "日次売買回転率", ko: "일간 회전율", es: "Tasa de rotación diaria", fr: "Taux de turnover quotidien" },
  "Switch attribution chart": { ja: "アトリビューションチャートを切り替え", ko: "기여도 차트 전환", es: "Cambiar gráfico de atribución", fr: "Changer de graphique d'attribution" },
  "Switch symbol PnL rank chart": { ja: "銘柄 PnL ランキングを切り替え", ko: "종목 PnL 순위 차트 전환", es: "Cambiar gráfico de ranking PnL por símbolo", fr: "Changer de classement PnL par symbole" },
  "Strategy summary metrics": { ja: "ストラテジー概要指標", ko: "전략 요약 지표", es: "Métricas de resumen de la estrategia", fr: "Indicateurs de synthèse de la stratégie" },
