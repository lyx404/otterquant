            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              <div className="rounded-2xl border border-border bg-card p-6 space-y-5">
                ...
                <div className="flex items-start gap-2 p-3 rounded-xl text-xs bg-primary/5 text-primary border border-primary/20">
                  ...
                  <span>{tr("Tip: You can modify these prompts or create your own. The skill supports natural language instructions for all Otter platform operations.", "提示：你可以修改这些提示词，或自行创建新的提示词。该技能支持对 Otter 平台全部操作的自然语言指令。")}</span>
                </div>
              </div>
            </div>
          )}
