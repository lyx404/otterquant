...
export interface Factor {
  ...
  osSharpe: number;
  // Card view fields
  category?: "official" | "graduated" | "community";
  tag?: string; // e.g. MOMENTUM, VOLUME, ON-CHAIN
  description?: string;
  userCount?: number;
  author?: string;
  agentSource?: "Codex" | "Claude code" | "Openclaw";
}

export const factors: Factor[] = [
  { id: "AF-001", name: "BTC Momentum RSI Cross", expression: "ts_rank(close/delay(close,14), 252) * ts_std(volume, 20)", market: "CEX", status: "active", sharpe: 1.42, fitness: 0.89, returns: "18.5%", turnover: "38.2%", drawdown: "6.8%", createdAt: "2025-12-15", testsPassed: 5, testsFailed: 1, testsPending: 0, osSharpe: 1.15, category: "official", tag: "MOMENTUM", description: "Captures 7-day price momentum across crypto assets using RSI crossover signals", userCount: 342, agentSource: "Codex" },
  { id: "AF-002", name: "ETH Volume Divergence", expression: "rank(ts_corr(close, volume, 10)) - rank(ts_delta(close, 5))", market: "CEX", status: "active", sharpe: 1.18, fitness: 0.72, returns: "14.2%", turnover: "42.1%", drawdown: "9.3%", createdAt: "2025-12-20", testsPassed: 4, testsFailed: 2, testsPending: 0, osSharpe: 0.95, category: "official", tag: "VOLUME", description: "Detects unusual volume spikes relative to 20-day average on ETH pairs", userCount: 287, agentSource: "Claude code" },
  { id: "AF-003", name: "DeFi TVL Alpha", expression: "ts_regression(tvl_change, price_return, 30, 'residual')", market: "DEX", status: "testing", sharpe: 0.87, fitness: 0.45, returns: "8.9%", turnover: "55.3%", drawdown: "15.2%", createdAt: "2026-01-05", testsPassed: 3, testsFailed: 3, testsPending: 1, osSharpe: 0.62, category: "community", tag: "DEFI", description: "Identifies alpha from TVL flow patterns across major DeFi protocols", agentSource: "Openclaw" },
  { id: "AF-004", name: "Cross-Exchange Spread", expression: "rank(spread_binance_okx) * ts_decay(volume_imbalance, 5)", market: "CEX", status: "active", sharpe: 2.15, fitness: 1.35, returns: "25.8%", turnover: "31.5%", drawdown: "4.2%", createdAt: "2025-11-28", testsPassed: 6, testsFailed: 0, testsPending: 0, osSharpe: 1.85, category: "graduated", tag: "ARBITRAGE", description: "Exploits price discrepancies between major CEX platforms using spread analysis", userCount: 421, author: "SpreadMaster", agentSource: "Codex" },
  { id: "AF-005", name: "Funding Rate Mean Rev", expression: "ts_zscore(funding_rate, 168) * -1 * rank(open_interest_change)", market: "CEX", status: "active", sharpe: 1.65, fitness: 1.02, returns: "21.3%", turnover: "28.7%", drawdown: "7.5%", createdAt: "2025-12-01", testsPassed: 5, testsFailed: 1, testsPending: 0, osSharpe: 1.42, category: "official", tag: "DERIVATIVES", description: "Mean reversion strategy on funding rates with open interest confirmation", userCount: 198, agentSource: "Claude code" },
  { id: "AF-006", name: "Uniswap LP Flow", expression: "rank(net_lp_flow_7d) * ts_rank(pool_volume, 30)", market: "DEX", status: "testing", sharpe: 0.55, fitness: 0.22, returns: "5.2%", turnover: "62.8%", drawdown: "18.5%", createdAt: "2026-01-10", testsPassed: 2, testsFailed: 4, testsPending: 1, osSharpe: 0.38, category: "community", tag: "DEFI", description: "Tracks net LP flow patterns on Uniswap pools for directional signals", agentSource: "Openclaw" },
  { id: "AF-007", name: "Whale Wallet Tracker", expression: "ts_sum(whale_net_transfer, 3) * rank(market_cap)", market: "CEX", status: "active", sharpe: 1.33, fitness: 0.81, returns: "16.7%", turnover: "35.4%", drawdown: "8.1%", createdAt: "2025-12-08", testsPassed: 5, testsFailed: 1, testsPending: 0, osSharpe: 1.08, category: "graduated", tag: "ON-CHAIN", description: "Tracks smart money flow patterns from whale wallets for trading signals", userCount: 156, author: "CryptoQuant_Pro", agentSource: "Codex" },
  { id: "AF-008", name: "Gas Fee Sentiment", expression: "ts_corr(gas_price_gwei, eth_return, 24) * rank(tx_count)", market: "DEX", status: "archived", sharpe: 0.32, fitness: 0.08, returns: "2.1%", turnover: "48.9%", drawdown: "22.3%", createdAt: "2025-10-15", testsPassed: 1, testsFailed: 5, testsPending: 0, osSharpe: 0.15, category: "community", tag: "ON-CHAIN", description: "Correlates gas fee patterns with ETH price movements for sentiment analysis", agentSource: "Claude code" },
  { id: "AF-009", name: "OI Delta Momentum", expression: "ts_delta(open_interest, 4) / ts_std(open_interest, 20) * sign(return_1h)", market: "CEX", status: "active", sharpe: 1.78, fitness: 1.15, returns: "22.9%", turnover: "33.2%", drawdown: "5.8%", createdAt: "2025-11-20", testsPassed: 6, testsFailed: 0, testsPending: 0, osSharpe: 1.55, category: "official", tag: "RISK-ADJUSTED", description: "Risk-adjusted returns normalized by recent volatility using OI delta signals", userCount: 421, agentSource: "Openclaw" },
  { id: "AF-010", name: "MEV Sandwich Detect", expression: "rank(sandwich_attack_freq) * ts_decay(price_impact, 10) * -1", market: "DEX", status: "testing", sharpe: 0.95, fitness: 0.52, returns: "10.8%", turnover: "58.1%", drawdown: "13.7%", createdAt: "2026-01-15", testsPassed: 3, testsFailed: 2, testsPending: 2, osSharpe: 0.72, category: "community", tag: "MEV", description: "Detects and avoids MEV sandwich attacks while capturing resistant opportunities", agentSource: "Codex" },
  { id: "AF-011", name: "SOL Orderbook Imbalance", expression: "ts_rank(bid_depth - ask_depth, 60) * rank(volume_24h)", market: "CEX", status: "active", sharpe: 0.72, fitness: 0.38, returns: "7.3%", turnover: "45.6%", drawdown: "11.2%", createdAt: "2026-01-20", testsPassed: 3, testsFailed: 3, testsPending: 0, osSharpe: 0.48, category: "community", tag: "ORDERBOOK", description: "Measures bid-ask depth imbalance on SOL pairs for short-term directional signals", agentSource: "Claude code" },
  { id: "AF-012", name: "Stablecoin Flow Tracker", expression: "ts_sum(usdt_net_flow, 7) * rank(market_cap) * sign(btc_return_1d)", market: "CEX", status: "active", sharpe: 0.45, fitness: 0.15, returns: "3.8%", turnover: "52.3%", drawdown: "19.8%", createdAt: "2026-02-01", testsPassed: 2, testsFailed: 4, testsPending: 0, osSharpe: 0.25, category: "community", tag: "ON-CHAIN", description: "Tracks USDT/USDC net flows across exchanges as a proxy for market sentiment", agentSource: "Openclaw" },
  { id: "AF-013", name: "Liquidation Cascade", expression: "ts_zscore(liquidation_volume, 48) * rank(funding_rate) * -1", market: "CEX", status: "active", sharpe: 1.05, fitness: 0.65, returns: "12.5%", turnover: "40.8%", drawdown: "10.5%", createdAt: "2026-01-25", testsPassed: 4, testsFailed: 2, testsPending: 0, osSharpe: 0.85, category: "official", tag: "DERIVATIVES", description: "Identifies cascading liquidation events and positions for mean reversion", agentSource: "Codex" },
  { id: "AF-014", name: "NFT Floor Price Alpha", expression: "ts_delta(floor_price, 3) / ts_std(floor_price, 14) * rank(collection_volume)", market: "DEX", status: "archived", sharpe: 0.28, fitness: 0.05, returns: "1.5%", turnover: "68.2%", drawdown: "28.5%", createdAt: "2025-09-10", testsPassed: 1, testsFailed: 5, testsPending: 0, osSharpe: 0.12, category: "community", tag: "NFT", description: "Attempts to capture alpha from NFT floor price movements across top collections", agentSource: "Claude code" },
  { id: "AF-015", name: "AVAX Momentum Breakout", expression: "ts_rank(close/delay(close,7), 120) * ts_rank(volume, 30)", market: "CEX", status: "active", sharpe: 0.92, fitness: 0.48, returns: "9.8%", turnover: "44.1%", drawdown: "12.8%", createdAt: "2026-02-05", testsPassed: 3, testsFailed: 2, testsPending: 1, osSharpe: 0.55, category: "community", tag: "MOMENTUM", description: "Breakout momentum strategy specifically tuned for AVAX ecosystem tokens", agentSource: "Openclaw" },
  { id: "AF-016", name: "Basis Trade Optimizer", expression: "rank(futures_premium) * ts_decay(spot_volume / futures_volume, 8)", market: "CEX", status: "active", sharpe: 1.95, fitness: 1.22, returns: "24.1%", turnover: "25.3%", drawdown: "3.8%", createdAt: "2025-11-15", testsPassed: 6, testsFailed: 0, testsPending: 0, osSharpe: 1.68, category: "graduated", tag: "ARBITRAGE", description: "Optimizes basis trading between spot and futures with volume-weighted decay", userCount: 385, author: "BasisKing", agentSource: "Codex" },
  { id: "AF-017", name: "Social Sentiment NLP", expression: "ts_rank(sentiment_score, 72) * rank(mention_count) * sign(price_change_4h)", market: "CEX", status: "testing", sharpe: 0.62, fitness: 0.28, returns: "6.1%", turnover: "55.7%", drawdown: "16.3%", createdAt: "2026-02-10", testsPassed: 2, testsFailed: 3, testsPending: 2, osSharpe: 0.42, category: "community", tag: "SENTIMENT", description: "NLP-based social media sentiment analysis for crypto trading signals", agentSource: "Claude code" },
  { id: "AF-018", name: "Multi-Chain Bridge Flow", expression: "ts_sum(bridge_net_flow, 5) * rank(chain_tvl) * ts_decay(gas_cost, 3)", market: "DEX", status: "active", sharpe: 0.38, fitness: 0.12, returns: "2.9%", turnover: "61.5%", drawdown: "21.2%", createdAt: "2026-01-30", testsPassed: 1, testsFailed: 4, testsPending: 1, osSharpe: 0.18, category: "community", tag: "CROSS-CHAIN", description: "Tracks cross-chain bridge flows to identify capital rotation patterns", agentSource: "Openclaw" },
];
...
export const leaderboardByFactorByEpoch: Record<string, LeaderboardEntry[]> = {
  "Round 4": [
    ...
    { rank: 12, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-013", factorName: "Orderbook Imbalance", osSharpe: 0.48, osFitness: 0.35, osReturns: "7.2%", compositeScore: 40.1, reward: "85 USDT", market: "CEX" },
    { rank: 13, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-014", factorName: "Volatility Surface Skew", osSharpe: 0.42, osFitness: 0.30, osReturns: "6.1%", compositeScore: 36.8, reward: "75 USDT", market: "CEX" },
    ...
    { rank: 16, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-015", factorName: "Funding Rate Decay", osSharpe: 0.35, osFitness: 0.25, osReturns: "5.3%", compositeScore: 31.5, reward: "55 USDT", market: "CEX" },
    { rank: 18, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-016", factorName: "Token Unlock Pressure", osSharpe: 0.22, osFitness: 0.15, osReturns: "3.1%", compositeScore: 20.4, reward: "45 USDT", market: "CEX" },
    { rank: 20, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-017", factorName: "CEX Withdrawal Flow", osSharpe: 0.18, osFitness: 0.12, osReturns: "2.5%", compositeScore: 17.2, reward: "40 USDT", market: "CEX" },
    { rank: 22, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-018", factorName: "Stablecoin Dominance", osSharpe: 0.12, osFitness: 0.08, osReturns: "1.8%", compositeScore: 13.6, reward: "0 USDT", market: "CEX" },
    { rank: 25, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-019", factorName: "Social Sentiment NLP", osSharpe: 0.08, osFitness: 0.05, osReturns: "1.2%", compositeScore: 10.1, reward: "0 USDT", market: "DEX" },
  ],
  "Round 3": [
...
export interface Notification {
  id: number;
  type: "alpha_test_result" | "epoch_reward" | "skill_update";
  title: string;
  message: string;
  time: string;
  read: boolean;
...
export const submissions: Submission[] = [
  ...
  {
    id: "SUB-013", factorId: "AF-011", factorName: "SOL Orderbook Imbalance",
    expression: "ts_rank(bid_depth - ask_depth, 60) * rank(volume_24h)",
    market: "CEX", submittedAt: "2026-03-14 08:15:30", status: "passed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 0.72, osSharpe: 0.48, fitness: 0.38, returns: "7.3%", turnover: "45.6%", drawdown: "11.2%",
    testsPassed: 3, testsFailed: 3, testsPending: 0,
  },
  {
    id: "SUB-014", factorId: "AF-012", factorName: "Stablecoin Flow Tracker",
    expression: "ts_sum(usdt_net_flow, 7) * rank(market_cap) * sign(btc_return_1d)",
    market: "CEX", submittedAt: "2026-03-13 15:42:10", status: "failed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 0.45, osSharpe: 0.25, fitness: 0.15, returns: "3.8%", turnover: "52.3%", drawdown: "19.8%",
    testsPassed: 2, testsFailed: 4, testsPending: 0,
    failReasons: [
      "IS Sharpe of 0.45 is below cutoff of 1.25",
      "Fitness of 0.15 is below cutoff of 1.0",
      "Max drawdown of 19.8% exceeds cutoff of 15%",
    ],
  },
  {
    id: "SUB-015", factorId: "AF-013", factorName: "Liquidation Cascade",
    expression: "ts_zscore(liquidation_volume, 48) * rank(funding_rate) * -1",
    market: "CEX", submittedAt: "2026-03-14 12:05:55", status: "passed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 1.05, osSharpe: 0.85, fitness: 0.65, returns: "12.5%", turnover: "40.8%", drawdown: "10.5%",
    testsPassed: 4, testsFailed: 2, testsPending: 0,
  },
  {
    id: "SUB-016", factorId: "AF-014", factorName: "NFT Floor Price Alpha",
    expression: "ts_delta(floor_price, 3) / ts_std(floor_price, 14) * rank(collection_volume)",
    market: "DEX", submittedAt: "2026-03-12 09:30:00", status: "failed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 0.28, osSharpe: 0.12, fitness: 0.05, returns: "1.5%", turnover: "68.2%", drawdown: "28.5%",
    testsPassed: 1, testsFailed: 5, testsPending: 0,
    failReasons: [
      "IS Sharpe of 0.28 is below cutoff of 1.25",
      "Max drawdown of 28.5% exceeds cutoff of 15%",
      "Turnover of 68.2% exceeds optimal range",
    ],
  },
  {
    id: "SUB-017", factorId: "AF-015", factorName: "AVAX Momentum Breakout",
    expression: "ts_rank(close/delay(close,7), 120) * ts_rank(volume, 30)",
    market: "CEX", submittedAt: "2026-03-14 17:50:20", status: "passed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 0.92, osSharpe: 0.55, fitness: 0.48, returns: "9.8%", turnover: "44.1%", drawdown: "12.8%",
    testsPassed: 3, testsFailed: 2, testsPending: 1,
  },
  {
    id: "SUB-018", factorId: "AF-016", factorName: "Basis Trade Optimizer",
    expression: "rank(futures_premium) * ts_decay(spot_volume / futures_volume, 8)",
    market: "CEX", submittedAt: "2026-03-15 07:20:00", status: "passed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 1.95, osSharpe: 1.68, fitness: 1.22, returns: "24.1%", turnover: "25.3%", drawdown: "3.8%",
    testsPassed: 6, testsFailed: 0, testsPending: 0,
    epochId: "Round 4", epochQualified: true,
  },
  {
    id: "SUB-019", factorId: "AF-017", factorName: "Social Sentiment NLP",
    expression: "ts_rank(sentiment_score, 72) * rank(mention_count) * sign(price_change_4h)",
    market: "CEX", submittedAt: "2026-03-14 20:10:35", status: "passed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 0.62, osSharpe: 0.42, fitness: 0.28, returns: "6.1%", turnover: "55.7%", drawdown: "16.3%",
    testsPassed: 2, testsFailed: 3, testsPending: 2,
  },
  {
    id: "SUB-020", factorId: "AF-018", factorName: "Multi-Chain Bridge Flow",
    expression: "ts_sum(bridge_net_flow, 5) * rank(chain_tvl) * ts_decay(gas_cost, 3)",
    market: "DEX", submittedAt: "2026-03-13 13:25:40", status: "failed",
    currentStep: 5, totalSteps: 5, progress: 100,
    isSharpe: 0.38, osSharpe: 0.18, fitness: 0.12, returns: "2.9%", turnover: "61.5%", drawdown: "21.2%",
    testsPassed: 1, testsFailed: 4, testsPending: 1,
    failReasons: [
      "IS Sharpe of 0.38 is below cutoff of 1.25",
      "Fitness of 0.12 is below cutoff of 1.0",
      "Max drawdown of 21.2% exceeds cutoff of 15%",
    ],
  },
];
