...
export const leaderboardByFactorByEpoch: Record<string, LeaderboardEntry[]> = {
  "Round 4": [
    ...
    { rank: 22, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-018", factorName: "Stablecoin Dominance", osSharpe: 0.12, osFitness: 0.08, osReturns: "1.8%", compositeScore: 13.6, reward: "35 USDT", market: "CEX" },
    { rank: 25, userId: "U-004", username: "AlphaSeeker_88", avatar: "AS", factorId: "AF-019", factorName: "Social Sentiment NLP", osSharpe: 0.08, osFitness: 0.05, osReturns: "1.2%", compositeScore: 10.1, reward: "30 USDT", market: "DEX" },
  ],
  "Round 3": [
