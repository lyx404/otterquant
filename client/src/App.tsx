...
const MarketplaceStrategyDetail = lazy(() => import("@/pages/MarketplaceStrategyDetail"));
  ...
  return (
    <Suspense fallback={null}>
      <Switch>
        ...
        <Route path="/marketplace/:id/strategies/:strategyId">
          <ProtectedRoute component={MarketplaceStrategyDetail} />
        </Route>
